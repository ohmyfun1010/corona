...
public class ServletAppContext implements WebMvcConfigurer{
	...
	// 데이터베이스 접속 정보 관리
		...
		@Bean
		public MapperFactoryBean<Hospitalmapper> getBoardMapper(SqlSessionFactory factory) throws Exception{
			MapperFactoryBean<Hospitalmapper> factoryBean = new MapperFactoryBean<Hospitalmapper>(Hospitalmapper.class);
